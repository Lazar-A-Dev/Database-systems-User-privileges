...
namespace PrivilegijeKorisnika.Mapiranja
{
    class KorisnikISMapiranja : ClassMap<KorisnikIS>
    {
        public KorisnikISMapiranja()
        {
            ...
            HasMany(x => x.Grupe).KeyColumn("JEDKORIME").Cascade.All();

            HasMany(x => x.Profili).KeyColumn("JEDKORIME").Cascade.All();
            ...
            //HasOne(x => x.Provera).PropertyRef("JEDKORIME").Cascade.All();
